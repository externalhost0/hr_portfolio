...
import { clamp, map, mix, smoothstep } from 'ts-play-core/modules/num'
...
// for info related to drawing
import { drawInfo } from 'ts-play-core/modules/drawbox'
...
export default {
    ...
    main(coord, context, cursor, buffer, userData) {
    ...
    //     drawInfo(context, cursor, buffer, userData);
    // },
